...
Things kept getting better and better. Following the recent [pacman upgrade](/post/2012/01/24/not-enough-random-bytes-available/), I was now facing issues with regards to package signatures. I had already successfully completed the keyring initialisation and I was a bit stumbled as to what exactly I was doing wrong.
