---
title: "The 'Big Brother' Advertising Framework"
date: 2009-02-10 04:24:00
---
...
Using data-mining the aggregated information about a user can be sorted in a timeline which can later be analysed and used to provide up-to-date suggestions. If a user visits a page which contains the keywords _'hd dvd'_, but the user has been looking for _'blue ray'_ in the last week, we can assume they are interested in an HD player of the latter kind and serve the appropriate advert.
